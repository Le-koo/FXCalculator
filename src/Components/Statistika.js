...
function Statistika() {
  ...
  return (
    <div class="statistika" style={{color: theme.syntax, background: theme.bg}}>
...
<center>
  ...
  <br/>
    ...
    <h1 style={{color: theme.syntax}} className="naslov">Pratite vrijednost Eura uživo</h1>
    ...
    <h1 style={{color: theme.syntax}} className="naslov">Pratite vrijednost crypto valuta uživo</h1>
